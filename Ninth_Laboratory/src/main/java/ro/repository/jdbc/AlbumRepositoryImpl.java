 ...
 * @author Alex Neagu
 */
public class AlbumRepositoryImpl extends BaseController implements AlbumRepository {
    ...
    private final ArtistRepositoryImpl artistDao;
    private final GenreRepositoryImpl genreDao;

    public AlbumRepositoryImpl(Connection con) {
        super(con);
        artistDao = new ArtistRepositoryImpl(con);
        genreDao = new GenreRepositoryImpl(con);
    }
    ...
    private Album mapResultSetToAlbum(ResultSet resultSet) throws SQLException, FindException {
        ...
        return new Album(
                ...
                artistDao.findById(resultSet.getInt("artist_id")),
                genreDao.findByAlbumId(albumId)
        );
    }
    ...
    /**
     * Finds all albums that have a specific {@link Genre}
     *
